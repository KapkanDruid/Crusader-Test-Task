...
namespace Game.Editor
{
    ...
    public class GridDataEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            _localGridSize = _sizeProperty.vector2IntValue;
            _localGridPattern = _gridConfig.GridPattern?.ToList() ?? new List<Vector2Int>();
        ...
        private void ShowPatternText()
        {
            ...
            var savedPattern = _gridConfig.GridPattern?.ToList() ?? new List<Vector2Int>();
            _isChangesSaved = IsCollectionsEqual(_localGridPattern, savedPattern);
